 ...
 * Returns a string
 */
int razer_attr_read_version(struct device *dev, struct device_attribute *attr, char *buf)
{
 ...
 */
int razer_attr_read_device_type(struct device *dev, struct device_attribute *attr, char *buf)
{
 ...
 * Returns a string
 */
int razer_attr_read_get_firmware_version(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_test(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_mode_none(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_mode_custom(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_mode_static(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_write_mode_wave(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_mode_spectrum(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_write_mode_reactive(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_write_mode_breath(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Returns a string
 */
int razer_attr_read_get_serial(struct device *dev, struct device_attribute *attr, char *buf)
{
 ...
 */
int razer_attr_read_get_battery(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_read_is_charging(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_set_charging_effect(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_write_set_charging_colour(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 * Returns a string
 */
int razer_attr_read_poll_rate(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
 ...
 * Sets the poll rate
 */
int razer_attr_write_poll_rate(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
...
int razer_attr_write_set_brightness(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 * Returns a string
 */
int razer_attr_read_set_brightness(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_write_mouse_dpi(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
    struct razer_report report;
 ...
 */
int razer_attr_read_mouse_dpi(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
    struct razer_report report;
    struct razer_report response;
 ...
 */
int razer_attr_write_set_idle_time(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_set_low_battery_threshold(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 * Writes the colour segments on the mouse.
 */
int razer_attr_write_set_key_row(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_device_mode(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Returns a string
 */
int razer_attr_read_device_mode(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_read_scroll_led_brightness(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_scroll_led_brightness(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    unsigned char brightness = (unsigned char)simple_strtoul(buf, NULL, 10);
 ...
 */
int razer_attr_read_logo_led_brightness(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Write device file "scroll_led_brightness"
 */
int razer_attr_write_logo_led_brightness(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    unsigned char brightness = (unsigned char)simple_strtoul(buf, NULL, 10);
 ...
 */
int razer_attr_write_scroll_led_state(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
    unsigned char enabled = (unsigned char)simple_strtoul(buf, NULL, 10);
 ...
 */
int razer_attr_read_scroll_led_state(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
 ...
 */
int razer_attr_write_logo_led_state(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
    unsigned char enabled = (unsigned char)simple_strtoul(buf, NULL, 10);
    struct razer_report report = razer_chroma_standard_set_led_state(VARSTORE, LOGO_LED, enabled);
 ...
 */
int razer_attr_read_logo_led_state(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
 ...
 */
int razer_attr_write_scroll_led_rgb(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_read_scroll_led_rgb(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_logo_led_rgb(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_read_logo_led_rgb(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_scroll_led_effect(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_read_scroll_led_effect(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 */
int razer_attr_write_logo_led_effect(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    unsigned char effect = (unsigned char)simple_strtoul(buf, NULL, 10);
 ...
 */
int razer_attr_read_logo_led_effect(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
 ...
 * Spectrum effect mode is activated whenever the file is written to
 */
int razer_attr_write_scroll_mode_spectrum(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Sets reactive mode when this file is written to. A speed byte and 3 RGB bytes should be written
 */
int razer_attr_write_scroll_mode_reactive(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Sets breathing mode by writing 1, 3 or 6 bytes
 */
int razer_attr_write_scroll_mode_breath(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Set the mouse to static mode when 3 RGB bytes are written
 */
int razer_attr_write_scroll_mode_static(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * No effect is activated whenever this file is written to
 */
int razer_attr_write_scroll_mode_none(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Spectrum effect mode is activated whenever the file is written to
 */
int razer_attr_write_logo_mode_spectrum(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Sets reactive mode when this file is written to. A speed byte and 3 RGB bytes should be written
 */
int razer_attr_write_logo_mode_reactive(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Sets breathing mode by writing 1, 3 or 6 bytes
 */
int razer_attr_write_logo_mode_breath(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * Set the mouse to static mode when 3 RGB bytes are written
 */
int razer_attr_write_logo_mode_static(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 * No effect is activated whenever this file is written to
 */
int razer_attr_write_logo_mode_none(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct usb_interface *intf = to_usb_interface(dev->parent);
    struct usb_device *usb_dev = interface_to_usbdev(intf);
    struct razer_report report;
 ...
 */
int razer_attr_write_backlight_led_state(struct device *dev, struct device_attribute *attr, const char *buf, int count)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
    unsigned char enabled = (unsigned char)simple_strtoul(buf, NULL, 10);
 ...
 */
int razer_attr_read_backlight_led_state(struct device *dev, struct device_attribute *attr, char *buf)
{
    struct razer_mouse_device *device = dev_get_drvdata(dev);
